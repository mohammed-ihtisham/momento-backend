...
|----------|------------------|------------------|-------------------|
| Checkpoint 1 — Minimum Viable Experience (MVP)| User Auth (Sign Up/Login), Home Dashboard, Create & View Profiles, Add/Edit Preferences | UserAuth, RelationshipProfiles | Mohammed (Frontend), Nayeemur (UserAuth Implementation + Tests), Alqasem (RelationshipProfiles Implementation + Tests) Milena (MongoDB Setup + Test App) |
| Checkpoint 2 — Memories + Planning | Add Memories (photos + notes), Basic Occasion Planning (single user), Upcoming Events List | RelationshipProfiles, OccasionPlanner | Mohammed (Frontend), Nayeemur (Enhance RelationshipProfiles  for Add Memories), Alqasem (Relevant MongoDB Updates + Test App), Milena (OccasionPlanner Implementation + Tests) |
| Final Deliverable — Collaborative Planning + Suggestions | Invite Collaborators, Checklist + Shared Notes, SuggestionEngine with direct add-to-checklist | OccasionPlanner, SuggestionEngine | Mohammed (Frontend), Nayeemur (Relevant MongoDB Updates + Test App & Help Melina w/ OccassionPlanner Updates), Alqasem (SuggestionEngine Implementation + Tests), Milena (Enhance OccasionPlanner for Collaboration) |
